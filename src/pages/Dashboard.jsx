...
import { Plus, Users, MessageSquare, CheckSquare, ArrowRight } from 'lucide-react'
...
function GroupCard({ group }) {
  ...
  return (
    <motion.div
      ...
      className="bg-surface dark:bg-surface-dark rounded-lg p-5 border border-border dark:border-white/8 cursor-pointer hover:shadow-2 transition-shadow"
    >
